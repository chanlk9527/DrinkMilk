...
export default function Setup({ onComplete }: Props) {
  ...
  if (mode === 'choose') {
    return (
      <div className="flex flex-col h-full bg-gradient-to-b from-warm-50 to-cream">
        {/* 顶部装饰区 */}
        <div className="flex-1 flex flex-col items-center justify-center px-8 pb-4">
          <div className="relative mb-6">
            ...
            <div className="absolute -bottom-1 -right-1 w-10 h-10 rounded-full bg-warm-400 flex items-center justify-center shadow-md">
        ...
        <div className="px-6 pb-10 space-y-3">
          <button
            ...
            className="w-full py-4 rounded-2xl bg-warm-400 text-white text-lg font-semibold shadow-md shadow-warm-400/30 active:bg-warm-500 active:shadow-sm transition-all flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-white text-text text-lg font-medium shadow-sm border border-warm-100 active:bg-warm-50 transition-all flex items-center justify-center gap-2"
          >
            <span className="text-xl">👨‍👩‍👧</span>
            加入已有记录
          </button>
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-10">
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl text-lg font-semibold bg-warm-400 text-white shadow-md shadow-warm-400/30 disabled:opacity-40 disabled:shadow-none active:bg-warm-500 active:shadow-sm transition-all"
            >
        ...
        {namePresets.map(name => (
          <button
            ...
            className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all ${
              myName === name
                ? 'bg-warm-400 text-white shadow-sm shadow-warm-400/30'
